                                ...
                                <div>
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <input type="file"
                                            ...
                                            accept="image/*"
                                            class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">
                                        <button type="button" id="open-camera" class="bg-blue-800 text-white px-4 py-2 rounded-md">
                                    ...
                                    <div id="webcam-container" class="hidden mt-4">
                                        <div class="relative">
                                            <video id="webcam" autoplay playsinline class="w-full max-w-md rounded-lg"></video>
                                            <button type="button" id="capture-photo" class="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-blue-800 text-white px-4 py-2 rounded-full">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M6.827 6.175A2.31 2.31 0 0 1 5.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 0 0-1.134-.175 2.31 2.31 0 0 1-1.64-1.055l-.822-1.316a2.192 2.192 0 0 0-1.736-1.039 48.774 48.774 0 0 0-5.232 0 2.192 2.192 0 0 0-1.736 1.039l-.821 1.316Z" />
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 12.75a4.5 4.5 0 1 1-9 0 4.5 4.5 0 0 1 9 0ZM18.75 10.5h.008v.008h-.008V10.5Z" />
                                                </svg>
                                        ...
                                        <img id="captured-photo" class="mt-4 w-full max-w-md rounded-lg hidden" alt="Captured photo">
                                    </div>
                                </div>
                            </div>
                            <div class="flex justify-end space-x-2">
                                <button type="button" class="bg-gray-800 text-white px-4 py-2 rounded-md hover:bg-gray-800" data-modal-hide="machine-modal">Cancel</button>
                        ...
                        <div class="p-6">
                            <form action="/editmachine" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="grid gap-4">
                                    ...
                                    <!-- Botones -->
                                    <div class="flex justify-end space-x-2">
                                        <button type="button" class="bg-gray-800 text-white px-4 py-2 rounded-md hover:bg-gray-800" data-modal-hide="edit-machine-modal-<?= $machine['id'] ?>">Cancelar</button>
                                        <button type="submit"
                ...
                <div class="bg-white p-2 sm:p-4 lg:p-3 px-4 rounded-lg shadow-md flex justify-between items-center">
                    ...
                    <div class="relative">
                        ...
                        <div id="dropdown-<?= $machine['id'] ?>" class="hidden absolute right-0 mt-2 w-40 sm:w-48 bg-gray-100 rounded-md shadow-lg z-10">
                            ...
                            <button type="button"
                                onclick="showMachineQRCode('<?php echo htmlspecialchars($machine['id']); ?>')"
                                class="block w-full text-left px-4 py-2 text-sm text-green-600 hover:bg-green-50"
                                id="generate-qr-<?php echo $machine['id'] ?>">
                                Generar QR
                            </button>
